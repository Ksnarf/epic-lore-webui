...
import type { BranchSummary, RepositorySummary, TreeNodeDto } from "@epic-lore-webui/api-types";
import type { Branch, Repository } from "@epic-lore-webui/lore-client/gen/lore/model/v1/model_pb";
import { FileMode, NodeType, type TreeNode } from "@epic-lore-webui/lore-client/gen/lore/thin_client/v1/model_pb";
